package be.kdg.prog6.maintenance.seeder;
...
@Component
@Profile("seed-db")
public class DbTestSeeder implements CommandLineRunner {
    ...
    public DbTestSeeder(DefectReportJpaRepository defectReportJpaRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        defectReport.setUuid(UUID.randomUUID());
        ...
        defectReport2.setUuid(UUID.randomUUID());
        ...
        DefectReportJpaEntity defectReport3 = new DefectReportJpaEntity();
        defectReport3.setUuid(UUID.randomUUID());
        defectReport3.setDescription("Test report 3 something is very wrong with the bike.");
        defectReport3.setCustomerContextReportId(UUID.randomUUID());
        defectReport3.setHasBrokenBrake(true);
        defectReport3.setCustomerId(UUID.randomUUID());
        defectReport3.setTimestamp(LocalDateTime.now());
        defectReport3.setVehicleId(UUID.randomUUID());
        defectReport3.setHasOtherDefect(true);
        defectReport3.setPhoto(photo);
        defectReport3.setStatus(VehicleDefectReportStatus.OPEN);
        defectReportJpaRepository.save(defectReport3);
